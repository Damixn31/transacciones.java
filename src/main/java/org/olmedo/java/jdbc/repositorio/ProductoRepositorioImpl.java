...
public class ProductoRepositorioImpl implements Repositorio<Producto> {
    ...
    public Producto guardar(Producto producto) throws SQLException {
        ...
        if (producto.getId() != null && producto.getId() > 0) {
            ...
            sql = "INSERT INTO productos(nombre, precio, categoria_id, sku, fecha_registro) VALUES(?,?,?,?,?)"; //fijarse en el orden donde estamos colcando para despues hacer el set
        }
           ...
           stmt.setString(4, producto.getSku());
            ...
            if(producto.getId() == null) {
                try (ResultSet rs = stmt.getGeneratedKeys()) {
                    if (rs.next()){
                        producto.setId(rs.getLong(1)); // con esto obtenemos el ultimo producto generado
                    }
                }
            }
